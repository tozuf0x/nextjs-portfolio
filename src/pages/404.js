...
export default function FourOhFour() {
    return(
        <div className={styles.transform}>
            <svg className={styles.svg} width="1123" height="837" viewBox="0 0 1123 837" fill="none" xmlns="http://www.w3.org/2000/svg">
            <rect width="1123" height="837" fill="#000b25"/>
            <g id="sky" filter="url(#filter0_d)">
            <rect id="background" x="30" y="26" width="1063" height="777" fill="#000b25"/>
            <g id="stars">
            ...
            <path id="Vector_34" d="M578.51 96.4834L578.52 96.4957L578.531 96.5076C583.685 102.221 590.434 111.588 597.797 126.726L597.798 126.73C613.465 158.638 621.544 194.732 621.655 231.32L622.93 650.608L517.93 650.927L516.661 233.319C516.547 195.664 524.762 158.515 541.048 125.774C546.594 114.716 552.917 104.371 559.813 96.561L559.822 96.5507L559.831 96.5402C560.972 95.1742 562.398 94.0744 564.009 93.3179C565.62 92.5615 567.377 92.1667 569.157 92.1613C570.937 92.1559 572.697 92.54 574.312 93.2866C575.928 94.0333 577.361 95.1244 578.51 96.4834Z" fill="#EEEEEE"/>
            ...
            <h1 className={[staatliches.className, styles.h1].join(" ")}>ERROR 404</h1>  
      <h2 className={styles.h2}>Запуск не удался</h2>
         <h2 className={styles.h2}>Страница не найдена - давайте вернемся на <Link href='/' className={styles.back}>Главную</Link></h2> 
            </div>
        </div>
     )
    }
