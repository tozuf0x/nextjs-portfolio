Проект моего портфолио на основе [Next.js](https://nextjs.org/), построенный с помощью [`create-next-app`](https://github.com/vercel/next.js/tree/canary/packages/create-next-app).
